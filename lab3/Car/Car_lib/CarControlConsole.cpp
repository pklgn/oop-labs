...
// TODO: если команду выполнить нельз€ - выдавать сообщение
// TODO: исправить переключение 2 передачи при движении задом: написать тест дл€ этой ситуации и исправить программу
...
{
	std::smatch result;
	// TODO: им€ дл€ регул€рного выражени€, обь€вить константу вне функции чтобы создавать только один раз
